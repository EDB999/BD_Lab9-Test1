...
namespace BD_Lab9_Test1.Service
{
    internal class ReportService
    {
        public void ExportExcel(DataGridView dataGrid)
        {
            ...
            workbook.SaveAs(@"C:\Users\Max\Education\2 курс\БД\LR11\Output.xls", Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlNoChange);
            app.Quit();
        }
        ...
        public void ExportWord(DataGridView dataGrid)
        {
            ...
            document.SaveAs2(@"C:\Users\Max\Education\2 курс\БД\LR12\Output.docx");
        }
    }
}
